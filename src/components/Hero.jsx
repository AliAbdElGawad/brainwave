  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] text-center mx-auto md:mb-20 lg:mb-[6rem] mb-[4rem]">
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              lg:aspect-[1024/490]"
              >
                <img className="w-full" src={robot} alt="Robot illustration" />
          ...
          <div
            className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:w-[138%]

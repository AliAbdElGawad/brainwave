    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 max-lg:py-4 xl:px-10">
        ...
        <nav
          ...
          } fixed lg:flex lg:static lg:bg-transparent lg:mx-auto top-[5rem] left-0 right-0
        bottom-0 bg-n-8`}
        >
          <div className="relative flex flex-col items-center justify-center m-auto z-2 lg:flex-row">
            {navigation.map((item) => (
              <a
                ...
                onClick={handleClick}
                href={item.url}
                className={`block leading-5 lg:hover:text-n-1 xl:px-12 relative font-code text-2xl
                uppercase transition-colors hover:text-color-1 px-6 py-6 md:py-8 lg:-mr-0.25 lg:text-xs 
                lg:font-semibold
